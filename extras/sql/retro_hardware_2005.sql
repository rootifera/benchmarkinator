...
('Duron', (SELECT id FROM cpubrand WHERE name='AMD')),
...
('TNT2 M64', (SELECT id FROM gpubrand WHERE name='NVIDIA')),
('TNT2 Pro', (SELECT id FROM gpubrand WHERE name='NVIDIA')),
('TNT2 Ultra', (SELECT id FROM gpubrand WHERE name='NVIDIA')),
